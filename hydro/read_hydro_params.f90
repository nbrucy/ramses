subroutine read_hydro_params(nml_ok)
  ...
  namelist/init_params/filetype,initfile,multiple,nregion,region_type &
       ...
       & ,prad_region &
#endif
       & ,omega_b, condinit_kind

  ! Hydro parameters
  namelist/hydro_params/gamma,courant_factor,smallr,smallc &
       & ,niter_riemann,slope_type,difmag,switch_solv,switch_solv_dens &
#if NENER>0
       & ,gamma_rad &
#endif
#ifdef SOLVERmhd
...
!!! NBrucy
  ...
  namelist/cooling_params/cooling,metal,isothermal,haardt_madau,J21 &
       & ,a_spec,self_shielding, z_ave,z_reion,ind_rsink,T2max,neq_chem,cooling_frig,dist_screen,NdirExt_m,NdirExt_n
